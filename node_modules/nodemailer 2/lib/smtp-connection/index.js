...
class SMTPConnection extends EventEmitter {
    ...
    /**
     * Handle the response for AUTH LOGIN command. We are expecting
     * '334 Fzc3dvcmQ6' (base64 for 'Password:'). Data to be sent as
    ...
    _actionAUTH_LOGIN_PASS(str, callback) {
        if (!/^334[ -]/.test(str)) {
            // expecting '334 Fzc3dvcmQ6'
            return callback(this._formatError('Invalid login sequence while waiting for "334 Fzc3dvcmQ6"', 'EAUTH', str, 'AUTH LOGIN'));
        }
